 ...
 */
@Component
public class InvitationEmailTemplateServiceImpl implements TemplateService{
    ...
    private String getSubject(List<Template.MergeTag> mergeTags){
        String subject = SubjectConstants.INVITATION_EMAIL;
    ...
    private String getTemplateContent(Template template){
        ...
        String templateContent = templateEngine.process(TemplateConstants.INVITATION_EMAIL_TEMPLATE_HTML_FILE_NAME, context);
