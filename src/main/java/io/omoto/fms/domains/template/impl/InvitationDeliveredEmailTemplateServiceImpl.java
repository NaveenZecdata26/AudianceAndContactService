 ...
 */
@Component
public class InvitationDeliveredEmailTemplateServiceImpl implements TemplateService{
    ...
    private String getSubject(List<Template.MergeTag> mergeTags){
        String subject = SubjectConstants.INVITATION_DELIVERED_EMAIL;
    ...
    private String getTemplateContent(Template template){
        ...
        String templateContent = templateEngine.process(TemplateConstants.INVITATION_DELIVERED_EMAIL_TEMPLATE_HTML_FILE_NAME, context);
