...
import static io.omoto.fms.commons.constants.TemplateConstants.OMOTO_SUCCESS_EMAIL;

/**
 * Created by Venkatesh Gowda on 21/2/18.
 */
@Component
public class CampaignCompletionEmailTemplateServiceImpl implements TemplateService{
    ...
    public Template getTemplate(Template template) {
        ...
        template.setFromEmail(OMOTO_SUCCESS_EMAIL);
        return template;
    }

    private String getSubject(List<Template.MergeTag> mergeTags){
        String subject = SubjectConstants.CAMPAIGN_STARTED_EMAIL;
    ...
    private String getTemplateContent(Template template){
        ...
        String templateContent = templateEngine.process(TemplateConstants.CAMPAIGN_STARTED_EMAIL_TEMPLATE_HTML_FILE_NAME, context);
