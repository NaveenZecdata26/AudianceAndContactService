 ...
 */
@Component
public class ReminderInvitationEmailTemplateServiceImpl implements TemplateService{
    ...
    private String getSubject(List<Template.MergeTag> mergeTags){
        String subject = SubjectConstants.REMINDER_INVITATION_EMAIL;
    ...
    private String getTemplateContent(Template template){
        ...
        String templateContent = templateEngine.process(TemplateConstants.REMINDER_INVITATION_EMAIL_TEMPLATE_HTML_FILE_NAME, context);
