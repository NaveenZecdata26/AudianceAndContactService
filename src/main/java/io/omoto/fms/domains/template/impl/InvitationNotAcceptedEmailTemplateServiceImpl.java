 ...
 */
@Component
public class InvitationNotAcceptedEmailTemplateServiceImpl implements TemplateService{
    ...
    private String getSubject(List<Template.MergeTag> mergeTags){
        String subject = SubjectConstants.INVITATION_NOT_ACCEPTED_EMAIL;
    ...
    private String getTemplateContent(Template template){
        ...
        String templateContent = templateEngine.process(TemplateConstants.INVITATION_NOT_ACCEPTED_EMAIL_TEMPLATE_HTML_FILE_NAME, context);
